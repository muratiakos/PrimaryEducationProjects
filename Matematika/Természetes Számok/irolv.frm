...
Begin VB.Form irolv 
   Appearance      =   0  'Flat
   BackColor       =   &H00A46E54&
   Caption         =   "Természetes számok írása, olvasása, helyesírása"
   ClientHeight    =   5220
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   7635
   ...
   Begin MSComctlLib.ImageList gombok 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "irolv.frx":1DB8
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "irolv.frx":221C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "irolv.frx":26B0
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub ellenorzes_mnu_Click()
   ...
   jo = True
    ...
    Else
        ...
        If szambol Then
            info.Caption = info.Caption & " A számokat kettõezerig egybe írjuk, de kettõezer felett a hármas tagozódás szerint kötõjelet teszünk."
        End If
    End If
End Sub
...
Dim legnagyobb As Integer
    ...
    For i = 1 To feladatok_szama
        ...
        With feladat(i)
            ...
            eredeti(i) = veletlen()
            If szambol Then
                If Len(meret_prb.Caption) < Len(szamok_AX.szamot_szovegge(CLng(eredeti(i)))) Then
                        meret_prb.Caption = szamok_AX.szamot_szovegge(CLng(eredeti(i)))
                    Else
...
be:
    ...
    If szambol Then
            veletlen = j
        Else
            veletlen = szamok_AX.szamot_szovegge(CLng(j))
    End If
End Function
...
beirt = LCase(beirt)
    If szambol Then
            If szamok_AX.szamot_szovegge(CLng(eredeti)) = beirt Then
                    hasonlit = 1
                Else
                    If CLng(eredeti) = szamok_AX.szoveget_szamma(beirt) And CLng(eredeti) > 2000 Then
                            hasonlit = 0
                        Else
                            hasonlit = -1
                    End If
            End If
        Else
            If eredeti = szamok_AX.szamot_szovegge(CLng(beirt)) Then
                    hasonlit = 1
                Else
                    hasonlit = -1
            End If
...
On Error Resume Next
    If Me.Width < 6540 Then Me.Width = 6540
    If Me.Height < 6660 Then Me.Height = 6660
